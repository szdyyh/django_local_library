...
class uthorListViewTest(TestCase):
    @classmethod
    ...
    def test_pagination_is_ten(self):
        resp = self.client.get(reverse('authors'))
        self.assertEqual(resp.status_code, 200)
        self.assertTrue('is_pagination' in resp.context)
    ...
    def setUp(self):
        ...
        for book_copy in range(number_of_book_copies):
            ...
            BookInstance.objects.create(book=test_book, imprint='Unlikely Imprint, 2016', due_back=return_date,
                                        boorower=the_borrower, status=status)
...
class RenewBookInstancesViewTest(TestCase):
    ...
    def setUp(self):
        ...
        return_date= datetime.date.today() + datetime.timedelta(days=5)
        self.test_bookinstance2=BookInstance.objects.create(book=test_book,i

mprint='Unlikely Imprint, 2016', due_back=return_date, borrower=test_user2, status='o')
